        ...
        {emails.map((email, index) => (
          <AccordionItem
            ...
            header={
              <div
                key={index}
                className='emailItemHeader'
                css={styles.emailItemHeader}>
                <div tw={'col-span-3 flex items-center justify-center'}>
                  {email.SenderName}
                </div>
                <div tw={'col-span-6 flex items-center justify-center'}>
                  {email.Subject}
                </div>
                <div tw={'col-span-3 flex items-center justify-center'}>
                  {email.Date}
