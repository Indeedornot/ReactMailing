...
export default function AccordionItem(props: AccordionItemProps) {
    ...
    return (
        <div className={'accordion-item'} css={css`${styles.accordionItem} ${notFlush(styles.accordionItemFlushable)}`} {...atr}>
            <div className={'accordion-header'} css={css`${styles.accordionHeader} ${notFlush(styles.accordionHeaderFlushable)}`} ref={headerRef}>
                {(() => {
                    switch (headerType) {
                        case 'button':
            ...
            <div className={'accordion-collapse'} css={styles.accordionCollapse} ref={bodyRef}>
